...
public class ShoppingListRecyclerAdapter
        extends RecyclerView.Adapter<ShoppingListRecyclerAdapter.ViewHolder>
    ...
    */
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            public void onClick(View view) {
                ...
                fade.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        ((MainActivity) context).startItemEditActivity(
                                shoppingItemList.get(position), position);
                    }
        ...
        holder.cbBought.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                shoppingItemList.get(position).save(); //updates SugarORM with check
            }
        });
    }
    ...
    /*
    Handles when an item is moved on the list. Updates new list with SugarORM
    */
    @Override
    ...
    public void addShoppingItem(ShoppingItem shoppingItem) {
        shoppingItem.save(); //adds to SugarOrm
    ...
    public void updateShoppingItem(int index, ShoppingItem shoppingItem) {
        ...
        shoppingItem.save(); //saves to SugarOrm
